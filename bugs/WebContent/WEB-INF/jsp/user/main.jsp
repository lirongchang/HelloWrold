...
<body class="fixed-sidebar full-height-layout gray-bg"
					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span><img
									alt="image" class="img-circle" id="myPic" src=" "
									style="width: 100px; height: 100px;" /> </span> <span
								class="block m-t-xs"><strong class="font-bold">
										开发人员 </strong></span> <span id="name" class="text-muted text-xs block">${username}<b
	...
	var picture;
      ...
      　　　　 url:'${pageContext.request.contextPath }/user/photo',
	   ...
	   document.getElementById("myPic").src="${pageContext.request.contextPath }/imgs/"+ picture;
	   document.getElementById("name").innerHTML=username; 
</script>
							<ul class="dropdown-menu animated fadeInRight m-t-xs">

								<li><a class="J_menuItem"
									href="${pageContext.request.contextPath }/user/personal">个人资料</a>
								</li>
					...
					<li><a href="#"> <i class="fa fa fa-bar-chart-o"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath }/admin/statistics">用户图表</a>
							</li>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath }/bug/statistics">查看缺陷</a>
							</li>

						</ul></li>

					<li><a href="#"> <i class="fa fa fa-bar-chart-o"></i> <span
							class="nav-label">与我相关的缺陷</span> <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath }/user/submit">我的提交</a>
							</li>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath }/user/mission">我的任务</a>
							</li>

						</ul></li>

					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/user/Project"><i
							class="fa fa-table"></i>查看项目</a></li>


					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/user/selectBug"><i
							class="fa fa-magic"></i> <span class="nav-label">缺陷列表</span></a></li>
				</ul>
			</div>
			</nav>
	</c:if>
					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span><img
									...
									style="width: 100px; height: 100px;" /></span> <span
								class="block m-t-xs"><strong class="font-bold">
										测试人员 </strong></span> <span id="name" class="text-muted text-xs block">${username}<b
									class="caret"></b></span> <script type="text/javascript">
      ...
      　　　　 url:'${pageContext.request.contextPath }/user/photo',
	   ...
	   document.getElementById("myPic").src="${pageContext.request.contextPath }/imgs/"+ picture;
								...
								<ul class="dropdown-menu animated fadeInRight m-t-xs">
									...
									<li><a class="J_menuItem"
										href="${pageContext.request.contextPath }/user/userTeam">小组管理</a>
									</li>
									<li><a href="login.html">安全退出</a></li>
								</ul>
						</div>
					...
					<li><a href="#"><i class="fa fa-envelope"></i> <span
							class="nav-label">与我相关的缺陷</span> <span
							class="label label-warning pull-right">${userscore}</span> </a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath }/user/submit">我的提交</a>
							</li>
					...
					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/user/Project"><i
							class="fa fa-table"></i> <span class="nav-label">项目列表</span></a></li>
					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/user/selectBug"><i
							class="fa fa-table"></i> <span class="nav-label">缺陷列表</span></a></li>

					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath}/user/ponderance"><i
							class="fa fa-table"></i> <span class="nav-label">严重级别列表</span></a></li>

					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath}/user/result"><i
							class="fa fa-table"></i> <span class="nav-label">缺陷结果列表</span></a></li>

					<li><a class="J_menuItem"  href="${pageContext.request.contextPath }/user/hello"><i
							class="fa fa-edit"></i> <span class="nav-label">提交缺陷</span></a></li>
							<script>
						    function toadd()
						    {
					...
					<%-- <li><a href="#"><i class="fa fa-cutlery"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/user/ponderance">查看严重级别</a>
							</li>
						</ul></li> --%>
					<%-- <li><a href="#"><i class="fa fa-cutlery"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/user/result">查看缺陷结果</a>
							</li>
						</ul></li> --%>
				</ul>
			</div>
					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span><img
									alt="image" class="img-circle" id="myPic" src=" "
									style="width: 100px; height: 100px;" /> </span> <span
								class="block m-t-xs"><strong class="font-bold">项目组长
								</strong></span> <span id="name" class="text-muted text-xs block">${username}<b
									class="caret"></b></span></a>
							<script type="text/javascript">
      ...
      　　　　 url:'${pageContext.request.contextPath }/user/photo',
	   ...
	   document.getElementById("name").innerHTML=username; 
					...
					<li><a href="#"> <i class="fa fa-home"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="" onclick="hello()"
								data-index="0">主页示例一</a></li>
					...
					<li><a href="#"><i class="fa fa-table"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath }/user/Project">查看项目</a>
							</li>
							<li><a
								href="${pageContext.request.contextPath }/user/userProject"
								class="J_menuItem">我的项目</a></li>
						</ul></li>
					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/user/selectBug"><i
							class="fa fa-magic"></i> <span class="nav-label">缺陷列表</span></a></li>
					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/user/ManageBug"><i
							class="fa fa-magic"></i> <span class="nav-label">管理的缺陷列表</span></a></li>

					<%-- <li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/user/addBug?flag=1"><i
							class="fa fa-magic"></i> <span class="nav-label">提交缺陷</span></a></li> --%>
					...
					<li class="nav-header">
						<div class="dropdown profile-element">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span><img
									alt="image" class="img-circle" id="myPic" src=" "
									style="width: 100px; height: 100px;" /> </span> <span
								class="block m-t-xs"><strong class="font-bold">管理员
								</strong></span> <span id="name" class="text-muted text-xs block">${username}<b
									class="caret"></b></span></a>
							<script type="text/javascript">
	...
	<div id="page-wrapper" class="gray-bg dashbard-1">
		...
		<div class="row content-tabs">
			...
			<div class="page-tabs-content">
				<a href="${pageContext.request.contextPath}/user/selectBug"
		...
		<div class="row J_mainContent" id="content-main">
			<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
				src="${pageContext.request.contextPath}/user/selectBug"
				tppabs="http://www.zi-han.net/theme/hplus/index_v1.html?v=4.0"
				frameborder="0"
				data-id="${pageContext.request.contextPath}/user/selectBug" seamless></iframe>
		</div>
		<div class="footer">
			...
			<ul class="nav nav-tabs navs-3">
				...
				<div class="tab-content">
					...
					<div id="tab-2" class="tab-pane">
						...
						<script
							src="${pageContext.request.contextPath }/js/hplus.min.js-v=4.0.0"></script>
						<script type="text/javascript"
