...
<body>
	...
	<%-- <span><img alt="image" class="img-circle" id="myPic" src="/pic/${user.picture}"
									style="width: %; height:15%" /> </span>
<img src="/pic/${user.picture}" width="20%" height="20%"/>
<p>
${user.username}
${user.email}
${user.telephone}
...
${user.userscore} --%>
	...
	<%-- 
 <div  id="reporter" style="width: 700px;height:50%;position: fixed;left: 20px;right:20px;">
 </div>
  ...
  <script type="text/javascript">
		    ...
		    series : [
		        {
		            ...
		            type:'bar',
		            barWidth: '60%',
		            data:[ ${user.hostnumber}, ${user.handlernumber}, ${user.signnumber},  ${user.userscore},  ${user.money}]
		        }
		    ]
		};
        // 使用刚指定的配置项和数据显示图表。
    ...
    <a class="J_menuItem" href="${pageContext.request.contextPath }/updateuser?flag=1&user_id=${user_id}">
								修改个人</a>
	...
	<div class="com_top">
		<h2>
			<a class="J_menuItem"
				href="${pageContext.request.contextPath }/updateuser?flag=1&user_id=${user_id}">修改</a>
		</h2>
		<p class="tuij_cas">
		...
		<dl>
			<dt>
				...
				<img src="${pageContext.request.contextPath }/imgs/${user.picture}" onclick="$('#popup').show();" />
	...
	<div class="Wallet">
		<a href="javascript:note();"><em class="Icon Icon5"></em>
			...
			</dl></a> <a href="${pageContext.request.contextPath }/Team/detailTeam?team_id=${user.team.team_id}" title="查看分组信息"><em class="Icon Icon7"></em>
			<dl class="b">
				<dt>我的分组</dt>
				<dd>
...
/
img /timg.jpg " .top_bt, .user_btn, .show_cart {
...
ol.popup_content li {
	list-style-type: lower-roman;
		...
		<div
			style="position: absolute; top: 30%; left: 30%; z-index: 1001; background: #FFF; width: 50%; min-width="300px;" height: auto; border: 5px solid #666666; padding-bottom: 10px;">
...
a:hover {
	text-decoration: underline;
									...
									<form enctype="multipart/form-data" method="post"
										...
										<br>
										<br>
											<img align="center" id="imgPre" src="" width="300px"
												height="215px" alt="点击上传用户头像" onclick="F_Open_dialog()"
												style="display: block;" />

											<div class="form-group">
												<input type="file" name="file" id="imgOne"
													required="required" style="display: none"
													onchange="preImg(this.id,'imgPre');" class="form-control" />
											</div>
